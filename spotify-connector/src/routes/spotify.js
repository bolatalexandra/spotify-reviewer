...
router.get('/login', (req, res) => {
    ...
    const scope = 'user-read-private user-read-email user-library-read user-follow-read playlist-read-private';
...
router.get('/callback', (req, res) => {
    ...
    const storedState = req.cookies ? req.cookies[env.SCS.SPOTIFY.STATE_KEY] : null;
    const redirectUri = `${env.SCS.URI}/spotify/callback`;
    ...
    if (state === null || state !== storedState) {
        ...
        const buffer = Buffer.from(env.SCS.SPOTIFY.CLIENT_ID + ':' + env.SCS.SPOTIFY.CLIENT_SECRET);
        const authOptions = {
