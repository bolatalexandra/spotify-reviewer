...
router.get("/", isAuthorized, (req, res) => {
  ...
  if (!req.session.user.spotify) {
    const requestUri = `${env.SCS.URI}/spotify/login`;
...
router.post("/token", (req, res) => {
  ...
  const requestUri = "http://spotify-connector:3000/api/scs/spotify/token";
